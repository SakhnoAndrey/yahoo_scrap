...
TEMP_DOWNLOAD_DIR = os.getenv("TEMP_DOWNLOAD_DIR", os.path.abspath("files"))
...
EXECUTABLE_PATH = ast.literal_eval(
    os.getenv("EXECUTABLE_PATH", '{"executable_path": "/home/lw/bin/geckodriver"}')
)
